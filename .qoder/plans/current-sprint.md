...
| 已完成 | guardrails 落地 | GR-01~GR-08 硬门禁 + advisory 两项，一键脚本对当前代码全绿（88 基线、分层无违规） |
| 已完成 | 棘轮基线登记 | `generate` 60 行白名单 + pytest 88 基线写入登记表 |
...
- pytest 88 用例全绿，不因文档工作引入代码改动（本迭代仅新增 `.qoder/` 文件）。
